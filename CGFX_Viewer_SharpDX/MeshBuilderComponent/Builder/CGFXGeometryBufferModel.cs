...
namespace CGFX_Viewer_SharpDX.MeshBuilderComponent.Builder
{
    ...
    /// </summary>
    public abstract class CGFXGeometryBufferModel : DisposeObject, IGUID, IGeometryBufferModel
    {
        ...
        protected CGFXGeometryBufferModel(PrimitiveTopology topology, IElementsBufferProxy vertexBuffer, IElementsBufferProxy indexBuffer)
        {
            Topology = topology;
